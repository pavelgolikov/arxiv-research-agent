...
links was checked back to a real chunk of the paper it names. `VERIFICATION.md`
records exactly which checks were automated, which needed reading, and which two
citations are weak enough to deserve a second opinion.
